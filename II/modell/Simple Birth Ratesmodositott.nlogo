...
@#$#@#$#@
<experiments>
  <experiment name="kék termékenységének hatása a piros kihalására" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>count turtles with [color = red] &lt; 1</exitCondition>
    <metric>ticks ;végén kell csak adatot kimenteni</metric>
